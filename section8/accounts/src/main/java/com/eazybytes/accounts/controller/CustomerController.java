...
public class CustomerController {
    ...
    public ResponseEntity<CustomersDetailsDto> fetchCustomersDetails(@RequestParam @Pattern(regexp = "[6-9]{1}[0-9]{9}", message = "Invalid mobile number") String mobileNumber) {

        CustomersDetailsDto cd = iCustomerService.fetchCustomersDetails(mobileNumber);
